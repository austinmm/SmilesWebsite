...
We provide you an example RESTful web service [people.py](https://gist.github.com/t-walker/29e5a2a5b0c6b2a03ba2e9084182cfa4) using Python and the Flask microframework to get you started. (Please check the workshop session video recorded on Thursday Sep 14 for Tyler's lecture on this.)
